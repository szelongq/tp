...
public class TypicalPersons {
    ...
    public static final Person ALICE = new PersonBuilder().withName("Alice Pauline")
            ...
            .withHoursWorked("70").withTags("friends").build();
    ...
    public static final Person CARL = new PersonBuilder().withName("Carl Kurz").withPhone("95352563")
            ...
            .withHourlySalary("18.00").withHoursWorked("67").build();
    public static final Person DANIEL = new PersonBuilder().withName("Daniel Meier").withPhone("87652533")
            .withEmail("cornelia@example.com").withAddress("10th street").withRole("Legal Assistant")
            .withLeaves("20").withHourlySalary("15.00").withHoursWorked("60").withTags("friends").build();
    public static final Person ELLE = new PersonBuilder().withName("Elle Meyer").withPhone("9482224")
            .withEmail("werner@example.com").withAddress("michegan ave").withRole("UI Designer")
            .withLeaves("20").withHourlySalary("16.66").withHoursWorked("50").build();
    public static final Person FIONA = new PersonBuilder().withName("Fiona Kunz").withPhone("9482427")
            .withEmail("lydia@example.com").withAddress("little tokyo").withRole("HR Manager")
            .withLeaves("15").withHourlySalary("16.66").withHoursWorked("40").build();
    public static final Person GEORGE = new PersonBuilder().withName("George Best").withPhone("9482442")
            .withEmail("anna@example.com").withRole("Team Manager").withLeaves("8").withHourlySalary("21.33")
