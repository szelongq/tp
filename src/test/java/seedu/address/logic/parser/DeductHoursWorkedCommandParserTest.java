...
public class DeductHoursWorkedCommandParserTest {
    private final DeductHoursWorkedCommandParser parser = new DeductHoursWorkedCommandParser();
    ...
    public void parse_indexSpecified_success() {
        ...
        DeductHoursWorkedCommand expectedCommand =
                new DeductHoursWorkedCommand(targetIndex, new HoursWorked(validHoursWorked),
        ...
        expectedCommand = new DeductHoursWorkedCommand(targetIndex, new HoursWorked("0"),
                new Overtime(validOvertime));
        assertParseSuccess(parser, userInput, expectedCommand);
    }
    ...
    public void parse_missingCompulsoryField_failure() {
        String expectedMessage = String.format(MESSAGE_INVALID_COMMAND_FORMAT, DeductHoursWorkedCommand.MESSAGE_USAGE);
    ...
    public void parse_invalidHoursWorked_failure() {
        String expectedMessage = String.format(MESSAGE_INVALID_HOURS_WORKED_INPUT,
    ...
    public void parse_invalidOvertime_failure() {
        String expectedMessage = String.format(MESSAGE_INVALID_OVERTIME_INPUT, DeductHoursWorkedCommand.MESSAGE_USAGE);
