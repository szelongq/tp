...
public class RemoveLeavesBeforeCommandParserTest {
    private RemoveLeavesBeforeCommandParser parser = new RemoveLeavesBeforeCommandParser();
    ...
    private static final String INVALID_YEAR_DATE = "999-02-50"; // Year must be in 4 digits
    ...
    private static final String INPUT_INVALID_YEAR = " " + PREFIX_DATE + INVALID_YEAR_DATE;
    ...
    @Test
    public void parse_givenDateYearNotValid_InvalidDateError() {
        String input = INPUT_INVALID_YEAR;
        String expectedMessage = String.format(MESSAGE_INVALID_DATE_FORMAT, RemoveLeavesBeforeCommand.MESSAGE_USAGE);
        assertParseFailure(parser, input, expectedMessage);
    }
