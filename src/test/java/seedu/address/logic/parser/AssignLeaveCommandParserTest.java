...
public class AssignLeaveCommandParserTest {
    private AssignLeaveCommandParser parser = new AssignLeaveCommandParser();
    ...
    private static final String INPUT_INVALID_YEAR = " " + FIRST_INDEX + " " + PREFIX_DATE + INVALID_YEAR_DATE;
