...
public class JsonAdaptedPersonTest {
    ...
    private static final String INVALID_ROLE = "UI/UX Designer";
    ...
    private static final String VALID_HORULYSALARY = BENSON.getSalary().toString();
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                ...
                VALID_LEAVES, VALID_HORULYSALARY, VALID_HOURSWORKED, VALID_TAGS);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(null, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_ROLE, VALID_LEAVES, VALID_HORULYSALARY, VALID_HOURSWORKED, VALID_TAGS);
    ...
    public void toModelType_invalidRole_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                INVALID_ROLE, VALID_LEAVES, VALID_HORULYSALARY, VALID_HOURSWORKED,
                VALID_TAGS);
    ...
    public void toModelType_nullLeaves_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_ROLE, null, VALID_HORULYSALARY, VALID_HOURSWORKED, VALID_TAGS);
    ...
    public void toModelType_negativeLeaves_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_ROLE, INVALID_LEAVES_NEGATIVE, VALID_HORULYSALARY, VALID_HOURSWORKED, VALID_TAGS);
    ...
    public void toModelType_characterInLeaves_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_ROLE, INVALID_LEAVES_CHAR, VALID_HORULYSALARY, VALID_HOURSWORKED, VALID_TAGS);
        String expectedMessage = Leave.MESSAGE_CONSTRAINTS;
        assertThrows(IllegalValueException.class, expectedMessage, person::toModelType);
    }
    ...
    public void toModelType_nullSalary_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_ROLE, VALID_LEAVES, null, VALID_HOURSWORKED, VALID_TAGS);
    ...
    public void toModelType_negativeSalary_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_ROLE, VALID_LEAVES, INVALID_HOURLYSALARY_NEGATIVE, VALID_HOURSWORKED, VALID_TAGS);
    ...
    public void toModelType_characterInSalary_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_ROLE, VALID_LEAVES, INVALID_HOURLYSALARY_CHAR, VALID_HOURSWORKED, VALID_TAGS);
        String expectedMessage = HourlySalary.MESSAGE_CONSTRAINTS;
        assertThrows(IllegalValueException.class, expectedMessage, person::toModelType);
    }
    ...
    public void toModelType_nullHoursWorked_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_ROLE, VALID_LEAVES, VALID_HORULYSALARY, null, VALID_TAGS);
    ...
    public void toModelType_negativeHoursWorked_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_ROLE, VALID_LEAVES, VALID_HORULYSALARY, INVALID_HOURSWORKED_NEGATIVE, VALID_TAGS);
    ...
    public void toModelType_characterInHoursWorked_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_ROLE, VALID_LEAVES, VALID_HORULYSALARY, INVALID_HOURSWORKED_CHAR, VALID_TAGS);
        String expectedMessage = HoursWorked.MESSAGE_CONSTRAINTS;
        assertThrows(IllegalValueException.class, expectedMessage, person::toModelType);
    }
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_ROLE,
                        VALID_LEAVES, VALID_HORULYSALARY, VALID_HOURSWORKED, invalidTags);
